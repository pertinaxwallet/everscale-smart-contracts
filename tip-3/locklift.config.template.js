module.exports = {
    compiler: {
      ...
      path: 'C:\\Users\\Developer\\.everdev\\solidity\\solc.exe',
    },
    linker: {
      // Path to your TVM Linker
      path: 'C:\\Users\\Developer\\.everdev\\solidity\\tvm_linker.exe',
    },
    lib: {
      path: 'C:\\Users\\Developer\\.everdev\\solidity\\stdlib_sol.tvm',
    },
    networks: {
